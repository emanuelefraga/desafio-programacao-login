Desafio Extra para a Disciplina de Programação para Testes de Software da Pós Graduação em Automação de Testes de Software (PGATS) - Professor Júlio de Lima.
